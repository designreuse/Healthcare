...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			...
			用户管理 - 编辑&nbsp;&nbsp;<small>User Management - Edit</small>
		</h3>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<span id="fileError" style="display:none"><font color="red">请选择图片格式</font></span>
									<div class="fileupload fileupload-new" data-provides="fileupload">
										...
										<%-- 	<img src="<%=path %>/showImg.action?userId=${userPO.userId }&id=<%=Math.random()%>" alt="" style="width: 200px; height: 200px;" /> --%>
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
								...
								<div class="col-md-10">
									<div class="input-icon right">                                       
										<button type="button" class="btn red btn-block" onClick="jumpUserPost('${userPO.userId }')"> 维护岗位</button>
									</div>
								</div>
							 </div>
							 <div class="form-group">
						...
						<div class="col-md-8">
								...
								<div class="form-group">
									...
									<div class="col-md-9 col-sm-12 col-xs-12" id="statusDiv">
										<script type="text/javascript">getSelect('status','status','1001','${userPO.status}',true,'form-control','','statusDiv');
										</script>
									</div>
								</div>
							</div>	
	            ...
	            error.hide();
	             var options = {
					...
					success: function(msg){  
						var jc={
								 message : "修改成功,是否返回查询列表?",
								 turl : "UserMain.action",
								 furl : "UpdateUserPage.action?userId="+'${userPO.userId }'
							};
