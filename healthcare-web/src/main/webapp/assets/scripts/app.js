...
var App = function () {
    ...
    // add by weibin 加载工作区
    var loadPageContentData = function(url){
        ...
        $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                pageContentBody.html('<h4>'+thrownError+'.</h4>');
                App.unblockUI(pageContent);
            },
            async: false
        });
    ...
    // add by weibin 加载工作区
    var loadPageContentDataPar = function(url,arg){
    	var pageContent = $('.page-content');
        var pageContentBody = $('.page-content .page-content-body');
    	App.blockUI(pageContent, false);
    ...
    return {
        ...
        loadContentData : function(url){
        	loadPageContentData(url);
        },
        loadContentDataPar : function(url,arg){
        	loadPageContentDataPar(url,arg);
        },
        scrollers : function (){
        	handleScrollers();
        }
